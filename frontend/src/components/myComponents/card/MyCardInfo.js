  ...
  return (
    <MyCard styles={styles || "w-fit"}>
      <div className="h-full w-full flex-col ">
        <div className="flex flex-col    rounded-t-lg   ">
          ...
          {header?.icon && (
            <div
              className={`${
                header?.badge && " "
              }  absolute p-2 rounded-full top-0 bg-zinc-800 shadow1 backdrop-blur  left-1/2 -translate-x-1/2 -translate-y-1/2 text-[40px] `}
            >
              <Icon
                icon={header?.icon}
        ...
        <div className="text-xs w-5/6 mb-auto   text-justify">
