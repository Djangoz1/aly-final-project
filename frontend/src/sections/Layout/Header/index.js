...
export const Header = ({ setter, isOpen }) => {
  ...
  return (
    <div className="flex items-center  w-[90%] mx-auto justify-between px-5 border border-x-0  border-black/5  pt-3  h-[8vh]">
      <Logo />

      <div className="text-black  flex   h-full mx-auto  items-center">
        {routes.map((route) => (
          <Link
            href={route.path}
